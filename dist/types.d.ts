...
export type LicenseClass = 'agpl' | 'source-available' | 'gpl' | 'lgpl' | 'weak' | 'permissive' | 'proprietary' | 'unknown';
export type ContributorStatus = 'on-domain' | 'unassigned-consumer' | 'third-party-domain' | 'identity-masked' | 'automation' | 'allowlisted';
