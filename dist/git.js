...
export function readHistory(opts) {
    ...
    let commitCount = 0;
    let coAuthored = 0;
    const bump = (name, email, date, viaTrailer) => {
    ...
    if (coAuthored)
        warnings.push(`${coAuthored} Co-authored-by trailers found. Those identities are counted as contributors.`);
